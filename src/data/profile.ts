...
export const universityProject = { name: "Badde Salemtak", description: "A mobile application connecting Lebanese residents with travelers visiting Lebanon, allowing residents to request products that are difficult to obtain locally.", technologies: ["React Native", "Node.js", "Express.js", "MongoDB", "AWS S3"], repositories: ["https://github.com/mmchokor/Badde-Salemtak--Senior-Project--Website", "https://github.com/mmchokor/Badde-Salemtak--Senior-Project--Backend", "https://github.com/mmchokor/Badde-Salemtak--Senior-Project"] };
