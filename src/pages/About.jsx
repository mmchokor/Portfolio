      ...
      <div className='max-w-3xl py-4 px-8 bg-neutral shadow-lg rounded-lg my-20 mx-auto'>
         ...
         <div className='pt-4'>
            ...
            <p className='mt-3 text-white-600'>
               ...
               for for Web Development, solving challenging tasks, and anything
               programming related.
            </p>
            <p className='mt-2 text-white-600'>
               Well organized person, problem solver, independent person with
               high attention to detail. Big fan of Formula 1, and anything Car
               related, also have a big passion for tech.
            </p>
            ...
            <Link to='/contact' className='text-white-600 text-indigo-500 text-lg'>
