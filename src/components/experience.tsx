      ...
      >
         ...
         <div className='timeline'>
            {experiences.map((experience, index) => (
               <article
                  className={`experience-card ${index === 0 ? 'experience-primary' : ''}`}
               ...
               >
                  ...
                  <div className='default-highlights'>
                     {experience.groups[0].items
                        .slice(0, index < 2 ? 3 : 2)
                        .map((item) => (
                           <p key={item}>{item}</p>
                        ))}
                     ...
                     <details className='experience-details'>
                        <summary>
                           <span className='summary-closed'>
                              Explore detailed engineering work
                           </span>
                           <span className='summary-open'>
                              Hide detailed engineering work
                           </span>
                        </summary>
